    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Tambah Hewan</div>

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('hewan.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('ras_id') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                            	...
                            	<select class="form-control" name="ras_id">
                            		...
                            		<option value="{{ $type->id }}" {{ old('ras_id') == $type->id ? 'selected' : ''}}>{{ $type->nama_ras }}</option>
                            		@endforeach
                            	</select>
                        ...
                        <div class="form-group{{ $errors->has('bobot') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="bobot" type="text" class="form-control" name="bobot" value="{{ old('bobot') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('umur') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="umur" type="text" class="form-control" name="umur" value="{{ old('umur') }}" required autofocus>
                    	...
                    	<div class="form-check form-check-inline">
						  <label class="form-check-label">
						    <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelamin1" value="L">Jantan
						  </label>
						</div>
						<div class="form-check form-check-inline">
						  <label class="form-check-label">
						    <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelamin2" value="P">Betina
						  </label>
						</div>
